...
public class SchoolManagementSystem extends JFrame implements ChangeListener,
        ActionListener {
    ...
    public SchoolManagementSystem(String frameTitle) {
        super(frameTitle);
        setResizable(true);
        setSize(400, 400);
    ...
    public static void main(String args[]) {
        SchoolManagementSystem outputScreen = new SchoolManagementSystem("Ekya School ITPL");
    }
    ...
    public String getStudentGrade() {
        ...
        if (studentDetails.physicsMarks < passMarks || studentDetails.biologyMarks < passMarks || studentDetails.mathsMarks < passMarks) {
            grade = "Fail";
        } else {
            int avgMarks = (studentDetails.physicsMarks + studentDetails.biologyMarks + studentDetails.mathsMarks) / 3;
    ...
    public String getClassTopper() {
        ...
        for (int id = 1; id <= lastID; id++) {
            studentDetails.getStudentDetails(id);
            int studentMarks = studentDetails.physicsMarks + studentDetails.biologyMarks + studentDetails.mathsMarks;
...
class Registration {
    ...
    private static String idFile = "d:\\id.dat";
    private static String studentFile = "d:\\studentfile.dat";
